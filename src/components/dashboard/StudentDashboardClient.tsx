          ...
          {chats.length === 0 ? (
            ...
            <div className="flex h-full w-full overflow-hidden">
              ...
              {(() => {
                ...
                if (!activeChat) {
                  return (
                    <div className="flex-1 flex flex-col items-center justify-center bg-[#FAFAFA] dark:bg-zinc-900/10 text-zinc-400 p-8 text-center">
                                ...
                                >
                                  ...
                                  <div className="max-w-[70%] flex flex-col">
                                    {isEditingThis ? (
                                      ...
                                      <div className="relative">
                                        ...
                                        {hasReactions && (
                                          ...
                                          >
                                            <button
                                              onClick={() => setActiveReactionPickerMsgId(m.id)}
                                            ...
                                            >
                                              <span>{Array.from(new Set(m.reactions!.map((r) => r.emoji))).join("")}</span>
                                    ...
                                    >
                                      ...
                                      {isMe && (
                                        <span className={m.isRead ? "text-[#0F5B47] font-bold text-[11px]" : "text-zinc-400 text-[11px]"}>
                                          {m.isRead ? "✓✓" : "✓"}
                                        </span>
                                      )}
                                      {!activeChat.isBlocked && (
