...
import { Globe, Menu, X, Sun, Moon, LogOut, AlertTriangle, Zap, Plus } from "lucide-react";
...
export default function Navbar() {
  ...
  const [isBuyPointsOpen, setIsBuyPointsOpen] = useState(false);
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 p-1 focus:outline-none cursor-pointer"
                  >
