        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-6">
          ...
          <div className="lg:col-span-6 bg-white dark:bg-zinc-900 border border-white/50 dark:border-zinc-800/80 rounded-[2.5rem] shadow-2xl p-8 md:p-12 space-y-6">
            ...
            <button
              ...
              className="w-full py-3.5 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-750 text-zinc-700 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 font-semibold rounded-xl text-xs md:text-sm shadow-sm flex items-center justify-center space-x-3 transition-colors cursor-pointer"
            >
